...
const initialCards = [
  {
    ...
    title: 'Caso #123',
    status: 'Novo',
    timeline: ['Criado', 'Em análise', 'Aguardando cliente'],
    column: 'received',
    analyst: 'João Silva'
  },
                          ...
                          <Draggable key={card.id} draggableId={card.id} index={index}>
                            {(provided) => (
                              <Card
                                ...
                                className="p-3 bg-[#F2F2F2] cursor-move"
                              >
                                ...
                                <div className="text-sm text-[#6F767E]">
                                  {card.timeline.slice(-3).map((event, i) => (
                                    <div key={i}>{event}</div>
                                  ))}
                                </div>
                                <div className="mt-2 text-xs text-[#6F767E]">
                                  {card.analyst}
                                </div>
                              </Card>
                            )}
